...
def main():
    ...
    with st.form(key="soa_form"):
        ...
        # GROUP 1 (200 Marks)
        g1_wish = st.radio("Do you wish to study subjects from GROUP 1? (200 Marks)", ["No", "Yes"])
        if g1_wish == "Yes":
        ...
        # GROUP 2 (200 Marks)
        g2_wish = st.radio("Do you wish to study subjects from GROUP 2? (200 Marks)", ["No", "Yes"])
        if g2_wish == "Yes":
        ...
        # GROUP 3 (100 Marks)
        g3_wish = st.radio("Do you wish to study subjects from GROUP 3? (100 Marks)", ["No", "Yes"])
        if g3_wish == "Yes":
        ...
        # GROUP 4 (100 Marks)
        g4_wish = st.radio("Do you wish to study subjects from GROUP 4? (100 Marks)", ["No", "Yes"])
        if g4_wish == "Yes":
        ...
        # GROUP 5 (100 Marks)
        g5_wish = st.radio("Do you wish to study subjects from GROUP 5? (100 Marks)", ["No", "Yes"])
        if g5_wish == "Yes":
        ...
        # GROUP 6 (100 Marks)
        g6_wish = st.radio("Do you wish to study subjects from GROUP 6? (100 Marks)", ["No", "Yes"])
        if g6_wish == "Yes":
        ...
        # GROUP 7 (100 Marks)
        g7_wish = st.radio("Do you wish to study subjects from GROUP 7? (100 Marks)", ["No", "Yes"])
        if g7_wish == "Yes":
